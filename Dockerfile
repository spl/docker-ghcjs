...
RUN stack setup ghcjs-0.1.0.20150924_ghc-7.10.2 && \
    rm -rf \
      $HOME/.stack/programs/x86_64-linux/*.tar.*z \
      $HOME/.stack/programs/x86_64-linux/ghcjs-0.1.0.20150924_ghc-7.10.2/src \
      $HOME/.stack/.stack/build-plan/* \
      $HOME/.stack/.stack/build-plan-cache/* \
      $HOME/.stack/.stack/precompiled/* \
      $HOME/.stack/.stack/setup-exe-cache/* \
      $HOME/.stack/.stack/snapshots/*
